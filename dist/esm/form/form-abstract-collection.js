...
export default class FormAbstractCollection extends FormAbstract {
    ...
    constructor(controls, validators) {
        super(validators);
        this.changesChildren = new BehaviorSubject(undefined);
    ...
    initSubjects_() {
        this.changesChildren = this.changesChildren.pipe(switchAll());
    ...
    initObservables_() {
        this.changes$ = this.changesChildren.pipe(map(() => this.value), shareReplay(1));
    }
    validate(value) {
        let errors;
